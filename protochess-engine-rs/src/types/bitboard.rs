...
impl BDimensions {
    ...
    // Given a list of invalid squares (coordinates of walls), return a BDimensions object
    pub fn from_walls(width: BCoord, height: BCoord, walls: &[(BCoord, BCoord)]) -> wrap_res!(BDimensions) {
